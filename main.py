...
right_image = PhotoImage(file='button_pictures/right_arrow.png').subsample(2, 3)
left_image = PhotoImage(file='button_pictures/left_arrow.png').subsample(2, 3)
edit_image = PhotoImage(file='button_pictures/edit.png')
delete_image = PhotoImage(file='button_pictures/delete.png')
...
load_button = Button(fractal_frame, text='Gallery', highlightbackground='#2E2252', command=switch_to_gallery    ).place(x=780, y=600)

#delete button
delete_button_editor = Button(fractal_frame, text='Delete', highlightbackground="#2E2252", command=controller.delete_fractal).place(x=780, y=650)
